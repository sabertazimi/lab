...
- [Agent CLI](https://github.com/sabertazimi/lab/tree/main/packages/agent-cli): Minimal Claude Code with rich tools, task planning, subagent orchestration, and skill system support.
